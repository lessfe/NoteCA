...
import com.example.noteca.databinding.ActivityAddNoteBinding
...
class AddNote : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            ...
            binding.etNote.setText(old_note.title)
            isUpdate = true
        } catch (e: Exception) {
        ...
        binding.imgCheck.setOnClickListener{
            ...
            if (title.isNotEmpty() || note_desc.isNotEmpty()) {
                ...
                Toast.makeText(this@AddNote, "Enter data", Toast.LENGTH_SHORT).show()
